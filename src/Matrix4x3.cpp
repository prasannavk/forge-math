...
#include "geom/EulerAngles.h"
#include "geom/MathUtil.h"
#include "geom/Matrix4x3.h"
#include "geom/Quaternion.h"
#include "geom/RotationMatrix.h"
...
void Matrix4x3::zeroTranslation() { tx = ty = tz = 0.0f; }
...
void Matrix4x3::setupLocalToParent(const Vector3 &pos,
                                   const EulerAngles &orient) {
...
void Matrix4x3::setupParentToLocal(const Vector3 &pos,
                                   const EulerAngles &orient) {
...
Vector3 getTranslation(const Matrix4x3 &m) { return Vector3(m.tx, m.ty, m.tz); }
